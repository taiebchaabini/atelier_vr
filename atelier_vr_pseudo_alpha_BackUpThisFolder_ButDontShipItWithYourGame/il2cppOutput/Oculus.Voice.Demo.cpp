...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void InteractionHandler_SetActivation_mDEDD01496E934DA04049F4C562B7DDA55E3CC8FE (InteractionHandler_t15828C462891DE52D1A7017CBD539754CB8B732E* __this, bool ___toActivated0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		AppVoiceExperience_t73F120132FB3DCEDD1AD48085A8A8D77419E60EF* L_6 = __this->___appVoiceExperience_7;
		NullCheck(L_6);
		VoiceService_Activate_m3DC058FC647D695E09E699E7EBDE5835FC3294B7(L_6, NULL);
		goto IL_0041;
	}
...
IL_0033:
	{
		...
		NullCheck(L_7);
		VirtualActionInvoker0::Invoke(30 /* System.Void Facebook.WitAi.VoiceService::Deactivate() */, L_7);
	}
...
IL_001d:
	...
	}
	{
		...
		NullCheck(L_9);
		float L_10 = L_9->___confidence_3;
...
IL_0043:
	{
		...
		WitIntentData_t6A544591D0035DEADD1FEE4F4598099B2E4436FD* L_12 = V_0;
		NullCheck(L_12);
		String_t* L_13 = L_12->___name_2;
		bool L_14;
		L_14 = String_Equals_mCC34895D0DB2AD440C9D8767032215BC86B5C48B(L_13, _stringLiteral3FB735594CCB68A0621882B06EC888D0B5D58FE3, 1, NULL);
		V_3 = L_14;
		bool L_15 = V_3;
		if (!L_15)
		{
	...
	}
	{
		...
		NullCheck(L_16);
		WitResponseNode_tACC149B056FE33C54D55A5EAB653A77902617DBB* L_17 = L_16->___response_1;
		String_t* L_18;
		L_18 = WitResultUtilities_GetFirstEntityValue_m86E5E3EEF5F22ED8A083862C5FB8CD46D6AB22D3(L_17, _stringLiteral3DFAD45D6A8DA43B5B1B588751F66ED962320CBC, NULL);
		V_4 = L_18;
		// OnValidateShapeSelect(sessionData, shape);
		VoiceSession_t91CD2D9FDE6B8FFF927125FF65929D922D08FE34* L_19 = ___sessionData0;
		String_t* L_20 = V_4;
		ShortResponseColorHandler_OnValidateShapeSelect_m72B5BB464D9C4946BABCCAC30B30D759D14029FA(__this, L_19, L_20, NULL);
		goto IL_00ad;
	}
...
IL_0078:
	{
		...
		WitIntentData_t6A544591D0035DEADD1FEE4F4598099B2E4436FD* L_21 = V_0;
		NullCheck(L_21);
		String_t* L_22 = L_21->___name_2;
		bool L_23;
		L_23 = String_Equals_mCC34895D0DB2AD440C9D8767032215BC86B5C48B(L_22, _stringLiteralE27A65E2557C298513C663D3A9DC8845724FE879, 1, NULL);
		V_5 = L_23;
		bool L_24 = V_5;
		if (!L_24)
		{
	...
	}
	{
		...
		VoiceSession_t91CD2D9FDE6B8FFF927125FF65929D922D08FE34* L_25 = ___sessionData0;
		NullCheck(L_25);
		WitResponseNode_tACC149B056FE33C54D55A5EAB653A77902617DBB* L_26 = L_25->___response_1;
		String_t* L_27;
		L_27 = WitResultUtilities_GetFirstEntityValue_m86E5E3EEF5F22ED8A083862C5FB8CD46D6AB22D3(L_26, _stringLiteral982EB241688495C1AF6152F618833411DB4F9B35, NULL);
		V_6 = L_27;
		// OnValidateColorSet(sessionData, color);
		VoiceSession_t91CD2D9FDE6B8FFF927125FF65929D922D08FE34* L_28 = ___sessionData0;
		String_t* L_29 = V_6;
		ShortResponseColorHandler_OnValidateColorSet_mF3B2056B3BB8B07360522B55BBC0778D908B9E52(__this, L_28, L_29, NULL);
	}
