...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void HandGrabUseInteractable_Reset_m1DC320B34677CF8499F1D3340E153A34F0B679FE (HandGrabUseInteractable_t7B18FA843065BC0F35943FF6E2908976DC55A1E4* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->____relaxedHandGrabPoses_27 = L_6;
		Il2CppCodeGenWriteBarrier((void**)(&__this->____relaxedHandGrabPoses_27), (void*)L_6);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void HandGrabUseInteractor_Start_m0E4F754356DD6D82563F988C19EDDBE0BD7DCB1C (HandGrabUseInteractor_tE6A0783D2AFEBEB1CCAD069379E40E15B551A575* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		bool* L_2 = (&((Interactor_2_t97A56A173D43E0EDF08F050226C6432B3D9F7E8B*)__this)->____started_32);
...
IL_001b:
	{
		...
		SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C** L_3 = (&__this->____fingerUseStrength_44);
		float L_4;
		...
		__this->____handUseShouldUnselect_47 = (bool)((((int32_t)L_9) == ((int32_t)0))? 1 : 0);
		// if (_usesHandPose && !_handUseShouldUnselect)
		bool L_10 = __this->____usesHandPose_45;
		if (!L_10)
		{
			goto IL_005d;
		}
	...
	{
		bool L_11 = __this->____handUseShouldUnselect_47;
...
IL_005e:
	...
	}
	{
		...
		SingleU5BU5D_t89DEFE97BCEDB5857010E79ECE0F52CF6E93B87C** L_13 = (&__this->____fingerUseStrength_44);
		float L_14 = V_1;
...
IL_004b_1:
			{
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733** L_12 = (&__this->____cachedRelaxedHandPose_41);
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733** L_13 = (&__this->____cachedTightHandPose_42);
				NullCheck(G_B5_1);
				bool L_14;
			...
			}
			{
				...
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733* L_20 = __this->____relaxedHandPose_39;
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733* L_21 = __this->____cachedRelaxedHandPose_41;
				NullCheck(L_20);
				HandPose_CopyFrom_mC60EE82AF04119C195F5738410C669828A1591A2(L_20, L_21, (bool)0, NULL);
				// _tightHandPose.CopyFrom(_cachedTightHandPose);
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733* L_22 = __this->____tightHandPose_40;
				HandPose_t0B0F57FC79F74C9D20E54C6999A45D59FDDAC733* L_23 = __this->____cachedTightHandPose_42;
				NullCheck(L_22);
